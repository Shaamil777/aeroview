    ...
    <section id="faq" className="bg-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-extrabold text-[#0A2540] mb-4">
        ...
        <div className="flex flex-col lg:flex-row bg-white rounded-3xl border border-border-subtle shadow-xl shadow-blue-900/5 overflow-hidden">
          ...
          <div className="lg:w-2/5 flex flex-col border-b lg:border-b-0 lg:border-r border-border-subtle bg-gray-50/50">
            {faqs.map((faq, i) => (
              <button
                ...
                className={`text-left px-6 py-6 border-b border-border-subtle last:border-b-0 flex items-center justify-between transition-all duration-300 focus:outline-none ${
                  activeTab === i 
              ...
              >
                <span className={`pr-4 text-lg ${activeTab === i ? 'font-bold' : ''}`}>
                  {faq.question}
                </span>
          ...
          <div className="lg:w-3/5 p-8 lg:p-16 flex flex-col justify-center bg-gradient-to-br from-[#F4F7FF] to-white relative overflow-hidden min-h-[400px]">
            ...
            >
              ...
              <h3 className="text-3xl font-bold text-[#0A2540] mb-6 leading-tight">
                {faqs[activeTab].question}
              </h3>
              <div className="w-12 h-1 bg-aviation rounded-full mb-6"></div>
